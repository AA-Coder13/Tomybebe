  ...
  const [items, setItems] = useState<GalleryItem[]>([
    {
      id: 'mem-1',
      src: starryCouple,
      title: 'Our Cosmic Stargaze',
      date: 'May 14, 2024',
      location: 'Serenity Ridge Observatory',
      description: 'Under an infinite ocean of twinkling stars, we promised to always hold onto each other. Time stood completely still while the cosmos rotated around us.',
      likes: 124,
    },
    {
      id: 'mem-2',
      src: beachCouple,
      title: 'Midsummer Golden Waves',
      date: 'July 28, 2024',
      location: 'Whispering Coast Beach',
      description: 'Walking hand-in-hand as the sun dipped below the sparkling line of water. Your hair was kissed by golden hour rays and the salty, warm breeze.',
      likes: 189,
    },
    {
      id: 'mem-3',
      ...
      location: 'The Velvet Grind Nook',
      description: 'Sharing a single hazelnut cup as the rain pattered on the windowpane. There is no weather in the world too cold when you are sat with me.',
      likes: 156,
    },
  ]);
